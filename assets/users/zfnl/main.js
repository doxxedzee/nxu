document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = ["./assets/users/zfnl/a.mp3"];
    ...
    async function fetchDiscordPresence() {
        const userId = '764520304893755403'; // Replace with your Discord User ID
        ...
        try {
            ...
            discordStatusDiv.innerHTML = `
                ...
                <div class="text-container">
                    <a class="username" style="color: #fff; font-weight: bold; background-image: url('./assets/main-page/gold.gif'); background-size: cover;">${data.data.discord_user.username} <span class="role">[pan :D]</span></a>
                    ${activityContent}
                </div>
            `;
        } catch (error) {
