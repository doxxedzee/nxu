document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = ["./assets/users/adversary/a.mp3"];
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (icons.length === 2) {
            iconContainer.classList.add('two-icons');
        } else {
            iconContainer.classList.remove('two-icons');
        }
    });
    ...
    async function fetchDiscordPresence() {
        const userId = '1243307661093507347'; // Replace with your Discord User ID
        ...
        try {
            ...
            discordStatusDiv.innerHTML = `
                ...
                <div class="text-container">
                    <a class="username" style="color: #ff0000; font-weight: bold; background-image: url('./assets/main-page/red.gif'); background-size: cover;">${data.data.discord_user.username} <span class="role">[adv :3]</span></a>
                    ${activityContent}
                </div>
            `;
        } catch (error) {
