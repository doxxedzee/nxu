document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = ["./assets/users/key/tellme.mp3", "./assets/users/key/dnd.mp3", "./assets/users/key/mazilove.mp3", "./assets/users/key/wakeup.mp3", "./assets/users/key/topfloor.mp3", "./assets/users/key/witchcraft.mp3"];
