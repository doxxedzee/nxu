document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = ["./assets/users/caught/a.mp3"];
    ...
    async function fetchDiscordPresence() {
        const userId = '1176644721800646744'; // Replace with your Discord User ID
        ...
        try {
            ...
            discordStatusDiv.innerHTML = `
                ...
                <div class="text-container">
                    <a class="username" style="color: #FFD700; font-weight: bold; background-image: url('./assets/main-page/gold.gif'); background-size: cover;">${data.data.discord_user.username} <span class="role">[Rich]</span></a>
                    ${activityContent}
                </div>
            `;
        } catch (error) {
