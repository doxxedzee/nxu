document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = ["./assets/users/lws/a.mp3"];
    ...
    async function fetchDiscordPresence() {
        const userId = '1266547874649604186'; // Replace with your Discord User ID
        ...
        try {
            ...
            discordStatusDiv.innerHTML = `
                ...
                <div class="text-container">
                    <a class="username" style="color: #ff0000; font-weight: bold; background-image: url('./assets/main-page/red.gif'); background-size: cover;">${data.data.discord_user.username} <span class="role">[Harm]</span></a>
                    ${activityContent}
                </div>
            `;
        } catch (error) {
