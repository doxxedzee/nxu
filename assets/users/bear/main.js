document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = ["./assets/users/bear/mamacita.mp3", "./assets/users/bear/praise.mp3", "./assets/users/bear/ss.mp3", "./assets/users/bear/ttp.mp3"];
    ...
    async function fetchDiscordPresence() {
        const userId = '1227319145561849918'; // Replace with your Discord User ID
        ...
        try {
            ...
            discordStatusDiv.innerHTML = `
                ...
                <div class="text-container">
                    <a class="username" style="color: #9B318E; font-weight: bold;">${data.data.discord_user.username} <span class="role">[VIP]</span></a>
                    ${activityContent}
                </div>
            `;
        } catch (error) {
