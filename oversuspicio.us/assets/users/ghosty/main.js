        ...
        try {
            ...
            discordStatusDiv.innerHTML = `
                ...
                <div class="text-container">
                    <a class="username" style="color: #FFD700; font-weight: bold; background-image: url('./assets/main-page/gold.gif'); background-size: cover;">${data.data.discord_user.username}</a>
                    ${activityContent}
                </div>
            `;
        } catch (error) {
