...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const songs = ["./assets/key/songs/a.mp3", "./assets/key/songs/b.mp3", "./assets/key/songs/h.mp3", "./assets/key/songs/k.mp3", "./assets/key/songs/c.mp3", "./assets/key/songs/d.mp3", "./assets/key/songs/e.mp3", "./assets/key/songs/f.mp3", "./assets/key/songs/g.mp3", "./assets/key/songs/tellme.mp3", "./assets/key/songs/dnd.mp3", "./assets/key/songs/wakeup.mp3", "./assets/key/songs/topfloor.mp3", "./assets/key/songs/witchcraft.mp3"];
    ...
    //     const userId = '1233099272338149428'; // Replace with your Discord User ID
    ...
    //         const statusIcons = {
    //             online: `<img src="./assets/key/discord-icons/online.webp" width="15" height="15" alt="Online">`,
    //             idle: `<img src="./assets/key/discord-icons/idle.png" width="15" height="15" alt="Idle">`,
    //             dnd: `<img src="../assets/key/discord-icons/dnd.webp" width="15" height="15" alt="Do Not Disturb">`,
    //             offline: `<img src="./assets/key/discord-icons/offline.webp" width="15" height="15" alt="Offline">`,
    //         };
    ...
    //                     const activity = activities.find(act => act.name !== 'Spotify') || activities[0];
    ...
    //                 <a class="username" style="color: #bb71e4; font-weight: bold; background-image: url('./assets/main-page/purple.gif'); background-size: cover;">${data.data.discord_user.username} <span class="role">[Manager]</span></a>
    //                 ${activityContent}
    //             </div>
    //         `;
    //     } catch (error) {
